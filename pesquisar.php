...
<div class="row">
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" class="col s12">
            <div class="row">
                <div class="input-field col s12">
                    <input type="text" name="parametro" class="validate">
                    <label for="first_name">Digite aqui sua busca</label>
    ...
    <?php 
        ...
        if($parametro) {
            $sql = "select * from contatos where nome like '$parametro%' or email like '$parametro%' or celular like '$parametro%' order by nome";
        } else {
...
if (isset($_POST['btn-pesquisar'])) {
                $sql = "select * from contatos where nome LIKE '%" . $_POST['p'] . "%' OR  email LIKE '%" . $_POST['p'] . "%' OR telefone LIKE '%" . $_POST['p'] . "%' ";
            } else
            {
